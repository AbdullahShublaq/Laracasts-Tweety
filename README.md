...
1. The profile page banner image and description are hard-coded. Make these dynamic for each user. - ![#6dff00](https://via.placeholder.com/15/6dff00/000000?text=+) `Complete`
2. Add the ability to attach an image when publishing a tweet.
3. There is currently no way to unlike a tweet. Add the ability to toggle a like. - ![#6dff00](https://via.placeholder.com/15/6dff00/000000?text=+) `Complete`
